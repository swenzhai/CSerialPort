...
typedef struct _BTP_SDAP_PNPINFO
{
	...
	BTUINT16	version_value; /* value of Version attribute */
...
typedef struct _BTP_HID_HOSTINFO
{
	BTP_SDAP_PNPINFO		pnpinfo;
	BtSdkRmtHIDSvcExtAttrStru	sdapInfo;
}BTP_HID_HOSTINFO;
